...
router.get('/groupby' ,( req , res)=>{
  ...
  router.get('/Edit/:id',(req,res)=>{
    ...
    .exec()
    .then(doctors =>{
         res.json({success  : true , message : "Edit are Succesfully Getted" , data: doctors})
    })
    .catch(error =>{
        res.json({success : false , message : " Editing process have an error" , error })
    })
...
router.post('/updatedoctor/:id' ,( req , res)=>{
 ...
 Doctor.findByIdAndUpdate({ id : req.param._id,
        $set: {
            fname: req.body.fname,
            lname: req.body.lname,
            gender: req.body.gender,
